...
        return api.sendMessage('Well can you provide me some question ', event.threadID, event.messageID);
...
        api.sendMessage('🧐Bro just chill', event.threadID, (err, info1) => {
